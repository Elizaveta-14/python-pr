...
def filter_banking_transactions(banking_description: list, search_bar: str) -> list:
...
def filter_description(banking_description: list, categories_operations: list) -> dict:
